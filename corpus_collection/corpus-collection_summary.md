...
**Korpus als epistemisches Objekt**
...
Abschließend haben wir unser eigenes Forschungskorpus — bestehend aus den Pressemitteilungen der Berliner Exekutive — [systematisch beschrieben](corpus-collection_building-our-corpus). Damit ist unser Forschungskorpus zum Scrapen bereit, sobald wir alle erforderlichen Tools, Formate und Techniken erlernt haben. 
```
